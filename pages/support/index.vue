      ...
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr>
              <th v-if="$store.state.user.role === 'manager'" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                Học viên
              </th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="(support, index) in $store.state.supports" :key="index">
                <td class="px-6 py-4 whitespace-nowrap text-gray-700 font-semibold" v-if="$store.state.user.role === 'manager'">
