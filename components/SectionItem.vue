  ...
  <div class="font-semibold text-gray-800 flex flex-col bg-gray-50">
    ...
    >
      ...
      >
        ...
        <div class="ml-auto flex-none flex items-center">
          <div
            v-if="hasResource && ($store.state.user.role === 'teacher' || lesson.resources)"
      ...
      <button v-if="hasResource && $store.state.user.role === 'teacher'" @click="addLesson" type="button" class="flex inline-block items-center bg-gray-50 text-gray-800 hover:bg-gray-100 px-3 py-2 border border-gray-300 rounded-lg">
